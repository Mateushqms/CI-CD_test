#!/usr/bin/env python3
"""Publica arquivos .pbix no workspace do Power BI via Service Principal."""
...
def publish(token: str, workspace_id: str, pbix_path: str) -> None:
...
def main(files: list[str]) -> None:
    pbix_files = [f.strip() for f in files if f.strip().endswith(".pbix")]
